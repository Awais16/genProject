...
<html>
    ...
    <body>
        ...
        <div id="show-questionnaire" class="content scaffold-show" role="main">
            ...
            <f:display bean="questionnaire" />
            <g:form resource="${this.questionnaire}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.questionnaire}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
